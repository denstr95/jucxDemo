...
public class MessagingClient extends CommunicationDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 24b = 8b buffer address + 8b buffer size
        ByteBuffer sendData = ByteBuffer.allocateDirect(16 + rkeyBuffer.capacity());
